...
const FinTechAI: React.FC = () => {
  ...
  const stats = useMemo(() => [
    {
      ...
      description: "4+ years of specialized experience delivering high-impact AI solutions for financial leaders and innovators."
    },
    {
      value: "15+",
      label: "FinTech Projects",
      description: "15+ successful FinTech AI projects, each tailored to unique business goals and industry challenges."
    },
    {
      value: "25+",
      label: "AI Models Built",
      description: "25+ custom AI models engineered for fraud prevention, credit analysis, and intelligent trading."
    },
    {
      value: "10+",
      label: "Happy Clients",
      description: "10+ financial organizations empowered with measurable gains in efficiency, security, and growth."
    },
    {
      value: "🌍",
      label: "Global Reach",
      description: "Delivering scalable, secure AI solutions to financial institutions worldwide—enabling global impact and local excellence."
    }
  ], []);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <AnimatedHero
        title="AI In FinTech"
        subtitle="Unlock the future of finance with AI—driving intelligent automation, robust fraud prevention, and hyper-personalized customer experiences."
        highlightText="FinTech"
        backgroundImage="/image/pages_img/fintech.jpg"
        gradientFrom="from-blue-900"
        gradientVia="via-cyan-800"
        gradientTo="to-blue-900"
        buttonText="Talk to an Expert"
        buttonLink="mailto:sureshbeekhani@26gmail.com"
      />
      ...
      <AnimatedSection className="py-20 px-6 lg:px-8 bg-gradient-to-br from-yellow-900/90 via-blue-900/90 to-blue-800/90">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              ...
              >
                <div className={`flex-shrink-0 w-12 h-12 ${benefit.bgColor} rounded-lg flex items-center justify-center group-hover:bg-opacity-40 transition-colors mb-3`}>
                  {benefit.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <span className="text-4xl font-extrabold text-yellow-600">{stat.value}</span>
