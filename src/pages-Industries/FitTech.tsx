    ...
    <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <div className="text-white space-y-6 sm:space-y-8">
        ...
        <p className="text-sm sm:text-base md:text-lg text-white font-medium leading-relaxed max-w-4xl drop-shadow-md">
          Transform fitness with AI-powered personalized workouts, wearable analytics, virtual coaches, and nutrition optimization. Enhance user engagement and outcomes.
        </p>
      </div>
    </div>
  </section>
        ...
        <div className="space-y-6 sm:space-y-8">
          <div className="space-y-4">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 leading-tight">
              AI-Driven Fitness <span style={{ color: '#a855f7' }}>Technology Innovation</span>
            </h2>
          </div>
          
          <div className="space-y-5 text-slate-600 text-lg leading-relaxed">
            <p>
              We are revolutionizing fitness and wellness with the power of Artificial Intelligence. By combining machine learning, computer vision, and wearable data analytics, we create intelligent fitness solutions that support personalized workouts, real-time form correction, nutrition optimization, and progress tracking.
            </p>
            <p>
              Our mission is to help fitness platforms and wellness apps deliver more engaging, effective, and personalized experiences that drive user retention and achieve better health outcomes.
            </p>
          </div>
        </div>
            ...
            <div className="relative z-10 bg-white p-2 rounded-3xl">
              <div className="relative rounded-2xl overflow-hidden h-64 sm:h-80 lg:h-96" style={{ clipPath: 'polygon(0 0, 100% 0, 100% 85%, 85% 100%, 0 100%)' }}>
                <img 
                  ...
                  alt="People using AI-powered fitness technology" 
    ...
    <div className="max-w-7xl mx-auto relative z-10">
      ...
      <div className="text-center space-y-4 mb-20 animate-fade-in">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white tracking-tight leading-tight">
          Capabilities and Benefits of <span style={{ color: '#a855f7' }}>AI and ML in FitTech</span>
        </h2>
        <p className="text-sm sm:text-base text-gray-400 max-w-2xl mx-auto font-medium leading-relaxed">
          Delivering excellence in <span className="text-gray-100 font-bold">well-being intelligence</span> and automated performance coaching.
        </p>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16 sm:mb-20">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-slate-600 font-medium max-w-3xl mx-auto leading-relaxed">
              Discover how our cutting-edge AI technology has transformed <span className="text-slate-900 font-bold">fitness platforms</span> and wellness apps worldwide.
            </p>
          </div>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-slate-600 font-medium max-w-2xl mx-auto">
              Everything you need to know about our <span className="text-slate-900 font-bold">AI-powered fitness</span> solutions and wellness technology.
            </p>
          </div>
