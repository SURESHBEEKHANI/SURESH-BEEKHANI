...
const PORTFOLIO_DATA = [
  {
    ...
    description: "Intelligent triage system that guides patients to appropriate care levels with 90% accuracy.",
  ...
  },
  {
    ...
    description: "Real-time patient monitoring with AI-powered alerts for concerning vital sign changes.",
  ...
  },
  {
    ...
    description: "Comprehensive telemedicine solution with integrated EHR, prescriptions, and AI documentation.",
  ...
  },
  {
    ...
    description: "Machine learning system that predicts patient health risks and enables preventive care.",
...
const TelemedicineDigitalHealth: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-cyan-100">
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 bg-gradient-to-br from-cyan-900 via-blue-800 to-cyan-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-base text-gray-300 max-w-3xl mx-auto">
              Explore our cutting-edge telemedicine AI solutions
            </p>
          </div>
          ...
          <div className="relative">
            <button
              ...
              className={`absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 hover:bg-white text-cyan-900 p-3 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 ${
            ...
            <button
              ...
              className={`absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 hover:bg-white text-cyan-900 p-3 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 ${
                ...
                {portfolioData.map((project) => (
                  ...
                  >
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <Link
                        to={project.link}
                        className="inline-flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold px-4 py-2 rounded-lg shadow-lg transition-all duration-300 text-sm"
                      >
                        View Case Study
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-base sm:text-xl text-gray-900 max-w-3xl mx-auto px-4">
              Common questions about telemedicine and digital health AI solutions.
            </p>
          </div>
          {/* FAQ Accordion */}
