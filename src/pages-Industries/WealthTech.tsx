    ...
    <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <div className="text-white space-y-6 sm:space-y-8">
        ...
        <p className="text-sm sm:text-base md:text-lg text-white font-medium leading-relaxed max-w-4xl drop-shadow-md">
          Transform wealth management with AI-powered robo-advisory, client onboarding, predictive analytics, and intelligent chatbots. Enhance client experience and scalability.
        </p>
      </div>
    </div>
  </section>
        ...
        <div className="space-y-6 sm:space-y-8">
          <div className="space-y-4">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 leading-tight">
              AI-Driven Wealth <span style={{ color: '#a855f7' }}>Management Innovation</span>
            </h2>
          </div>
    ...
    <div className="max-w-7xl mx-auto relative z-10">
      ...
      <div className="text-center space-y-4 mb-20 animate-fade-in">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white tracking-tight leading-tight">
          Capabilities and Benefits of <span style={{ color: '#a855f7' }}>AI and ML in WealthTech</span>
        </h2>
        <p className="text-sm sm:text-base text-gray-400 max-w-2xl mx-auto font-medium leading-relaxed">
          Driving innovation in <span className="text-gray-100 font-bold">wealth management operations</span> and automated financial planning.
        </p>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16 sm:mb-20">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-slate-600 font-medium max-w-3xl mx-auto leading-relaxed">
              Discover how our cutting-edge AI technology has transformed <span className="text-slate-900 font-bold">wealth management operations</span> and financial planning worldwide.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-slate-600 font-medium max-w-2xl mx-auto">
              Everything you need to know about our <span className="text-slate-900 font-bold">AI-powered WealthTech</span> solutions and smart investing.
            </p>
          </div>
