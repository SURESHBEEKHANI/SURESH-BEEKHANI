...
const MeetFounder = () => {
  ...
  return (
    <section id="founder" className="relative overflow-hidden border-b border-white/10 bg-[#050505] py-16 text-white sm:py-20 lg:py-24">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid items-center gap-10 lg:grid-cols-[0.78fr_1.22fr] lg:gap-16">
        <motion.div
        ...
        >
          ...
          <div className="relative overflow-hidden border border-white/10 bg-[#111111] px-8 pt-8">
            ...
            <img src="/image/sureshbeekhani.avif" alt="Suresh Beekhani, Founder and Lead AI Architect" width={1199} height={1312} className="relative z-10 mx-auto block w-full max-w-[280px] object-contain object-bottom" loading="lazy" decoding="async" />
          </div>
        </motion.div>
