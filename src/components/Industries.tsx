          ...
          {industries.map((industry) => {
            ...
            const cardContent = hasImage ? (
              <div className="relative w-full h-56 flex items-center justify-center">
                ...
                <span className="relative z-20 text-xl font-semibold text-white drop-shadow-xl text-center">{industry.name}</span>
              </div>
            ) : (
              <div className="flex flex-col items-center justify-center w-full h-56">
                <span className="text-5xl mb-4 w-full text-center">❓</span>
                <span className="text-xl font-semibold text-gray-800 w-full text-center">{industry.name}</span>
              </div>
            );
            return isHealthTech ? (
              <a
