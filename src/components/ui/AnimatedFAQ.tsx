        ...
        <div className="space-y-4">
          {faqData.map((faq, index) => (
             ...
             >
                 ...
                 className="w-full px-6 py-3 text-left flex justify-between items-center hover:bg-gray-50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-400"
              ...
              <AnimatePresence>
                   ...
                   >
                     <div className="px-6 pb-4 text-gray-700 border-t-0">
                       <p>{faq.answer}</p>
                     </div>
                   </motion.div>
                 )}
