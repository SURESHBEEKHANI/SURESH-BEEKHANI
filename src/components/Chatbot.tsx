  ...
  const sendMessage = useCallback(
    async (text: string) => {
      ...
      try {
        ...
        // Error message when Netlify functions are not available
        const bid = Date.now() + 1;
        setMessages((m) => [
          ...m,
          {
            id: bid,
            text: "I'm sorry, I'm currently unable to connect to my AI services. Please try again later or contact Suresh directly through the contact form on this website.",
            from: 'bot',
            time: formatTime(),
            reactions: []
          },
