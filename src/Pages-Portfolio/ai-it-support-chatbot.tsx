...
const AIITSupportChatbot: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error: insertError } = await supabase.from("case_study_downloads_data").insert([
        {
          ...
          case_study: "ai-it-support-chatbot",
        },
      ]);
      ...
      window.open(
        "https://drive.google.com/uc?export=download&id=1OWVC7JR6IDT67if9LB8J4UrKeERUFLYZ",
        "_blank"
      );
    }
  };
  ...
  return (
    <>
      ...
      <section className="relative w-full min-h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 opacity-20 bg-[url('/image/pages_img/ai-it-support-chatbot.jpg')] bg-cover bg-center" />
        <div className="relative z-10 max-w-6xl mx-auto container-padding py-16 sm:py-24">
          <div className="text-center text-white space-y-6">
            ...
            <p className="body-medium text-gray-100 max-w-3xl mx-auto leading-relaxed">
              AI-driven chatbot to resolve IT issues, streamline support, and enhance user satisfaction.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
              Our client, a global IT services provider, faced challenges with high support ticket volumes, delayed
              resolutions, and inconsistent user experiences, impacting productivity and satisfaction.
            </p>
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
              We implemented an AI-powered IT Support Chatbot that leverages natural language processing to resolve
              common IT issues, automate ticket creation, and provide instant support. The platform ensures faster
              resolutions and improved user experiences.
            </p>
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
              <strong>Key outcomes:</strong>
            </p>
            <ul className="list-disc list-inside text-sm text-gray-700 leading-relaxed mb-4">
              <li>Reduced ticket resolution time by 50%</li>
              <li>Automated resolution of common IT issues</li>
              <li>Improved user satisfaction and productivity</li>
              <li>Streamlined IT support workflows</li>
            </ul>
            <p className="text-sm text-gray-700 leading-relaxed">
              Download the full case study to see how our AI solution transformed IT support, improved efficiency, and
...
export default AIITSupportChatbot;
