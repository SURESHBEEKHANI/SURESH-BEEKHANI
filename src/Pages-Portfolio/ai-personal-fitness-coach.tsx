...
const AIPersonalFitnessCoach: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error: insertError } = await supabase.from("case_study_downloads").insert([
        {
          ...
          case_study: "ai-personal-fitness-coach",
        },
      ]);
      ...
      if (insertError) {
        ...
        window.open(
          "https://drive.google.com/uc?export=download&id=YOUR_PERSONAL_FITNESS_COACH_CASE_STUDY_ID",
          "_blank"
        );
      }
    } catch (err: any) {
  ...
  return (
    <>
      ...
      <section className="relative w-full min-h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 opacity-20 bg-[url('/image/pages_img/ai-personal-fitness-coach.jpg')] bg-cover bg-center" />
        <div className="relative z-10 max-w-6xl mx-auto container-padding py-16 sm:py-24">
          <div className="text-center text-white space-y-6">
            ...
            <p className="body-medium text-gray-100 max-w-3xl mx-auto leading-relaxed">
              A virtual coach that uses computer vision and analytics to guide workouts, correct form, and keep users
        ...
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
              Our client, a connected fitness company, wanted to create a truly interactive training experience that
              adapts to each user’s form, performance, and motivation level in real time.
            </p>
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
              We implemented an AI Personal Fitness Coach that uses computer vision and sensor data to analyze movement,
              adjust workouts on the fly, and provide targeted feedback. The system personalizes training plans, syncs
              with wearables, and uses gamification to drive long-term engagement.
            </p>
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
              <strong>Key outcomes:</strong>
            </p>
            <ul className="list-disc list-inside text-sm text-gray-700 leading-relaxed mb-4">
              <li>Higher workout completion rates and session frequency</li>
              <li>Reduced injury risk through real-time form coaching</li>
              <li>Increased subscription retention for the fitness platform</li>
              <li>Rich performance data to inform product and program design</li>
            </ul>
            <p className="text-sm text-gray-700 leading-relaxed">
              Download the full case study to see how AI coaching can power next-generation digital fitness products and
          ...
          <div className="bg-[#0a0435] text-white rounded-2xl shadow-2xl p-8 sm:p-10 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-sm text-indigo-100 mb-6">
                Fill in your details to access the full implementation details, personalization engine, and engagement
                results.
              </p>
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full rounded-lg border border-white/10 bg-white/10 px-3 py-2 text-sm text-white placeholder:text-indigo-200/60 focus:outline-none focus:ring-2 focus:ring-fuchsia-400"
                    placeholder="Fitness / wellness brand"
                  />
                </div>
                ...
                <div className="flex items-start gap-2 pt-1">
                  <input
                    ...
                    required
                  />
                  <label htmlFor="fitness-consent" className="text-xs text-indigo-100 leading-relaxed">
                    I agree to the{" "}
...
export default AIPersonalFitnessCoach;
