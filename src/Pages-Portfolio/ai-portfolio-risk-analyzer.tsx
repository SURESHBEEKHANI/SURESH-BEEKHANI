  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (insertError) {
        ...
        window.open(
          "https://drive.google.com/uc?export=download&id=YOUR_PORTFOLIO_RISK_ANALYZER_CASE_STUDY_ID",
          "_blank"
        );
      }
    } catch (err: any) {
  ...
  return (
    <>
      ...
      <section className="relative w-full min-h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 opacity-20 bg-[url('/image/pages_img/ai-portfolio-risk-analyzer.jpg')] bg-cover bg-center" />
        <div className="relative z-10 max-w-6xl mx-auto container-padding py-16 sm:py-24">
          <div className="text-center text-white space-y-6">
            ...
            <p className="body-medium text-gray-100 max-w-3xl mx-auto leading-relaxed">
              Scenario analysis, stress testing, and risk metrics that help institutions and investors understand and
        ...
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
              Our client, an asset management firm, needed faster, more transparent risk analytics across complex
              multi-asset portfolios, without adding headcount to the risk team.
            </p>
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
              We implemented an AI Portfolio Risk Analyzer that combines traditional risk metrics with machine
              learning–driven scenario analysis and factor decomposition, giving PMs and risk officers a shared,
              explainable view of exposure.
            </p>
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
              <strong>Key outcomes:</strong>
            </p>
            <ul className="list-disc list-inside text-sm text-gray-700 leading-relaxed mb-4">
              <li>Reduced time to produce daily and intraday risk reports</li>
              <li>Improved visibility into concentration and factor risk across portfolios</li>
              <li>Earlier detection of limit breaches and emerging stress scenarios</li>
              <li>Stronger risk governance with consistent, auditable analytics</li>
            </ul>
            <p className="text-sm text-gray-700 leading-relaxed">
              Download the full case study to see how AI can enhance VaR, stress testing, and portfolio oversight for
          ...
          <div className="bg-[#0a0435] text-white rounded-2xl shadow-2xl p-8 sm:p-10 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-sm text-indigo-100 mb-6">
                Fill in your details to access the analytics architecture, model design, and risk impact metrics.
              </p>
...
export default AIPortfolioRiskAnalyzer;
