...
const AIFraudDetectionSystem: React.FC = () => {
      ...
      const { error: insertError } = await supabase.from("case_study_downloads").insert([
        {
          ...
          case_study: "ai-fraud-detection-system",
        },
      ]);
  ...
  return (
    <>
      ...
      <section className="relative w-full min-h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 opacity-20 bg-[url('/image/pages_img/ai-fraud-detection-system.jpg')] bg-cover bg-center" />
        <div className="relative z-10 max-w-6xl mx-auto container-padding py-16 sm:py-24">
          <div className="text-center text-white space-y-6">
            ...
            <p className="body-medium text-gray-100 max-w-3xl mx-auto leading-relaxed">
              AI-powered fraud prevention to detect anomalies, mitigate risks, and safeguard financial transactions.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
              Our client, a leading financial institution, faced challenges with manual fraud detection, delayed
              responses, and increasing fraudulent activities, impacting customer trust and revenue.
            </p>
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
              We implemented an AI-powered Fraud Detection System that leverages machine learning to identify anomalies,
              predict fraudulent patterns, and automate alerts. The platform ensures proactive fraud prevention and
              enhances security.
            </p>
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
            ...
            <ul className="list-disc list-inside text-sm text-gray-700 leading-relaxed mb-4">
              <li>Reduced fraud detection time by 60%</li>
              <li>Improved accuracy of fraud identification</li>
              <li>Minimized financial losses due to fraud</li>
              <li>Enhanced customer trust and satisfaction</li>
            </ul>
            <p className="text-sm text-gray-700 leading-relaxed">
              Download the full case study to see how our AI solution transformed fraud prevention, improved security,
              and safeguarded financial transactions.
            </p>
          </div>
