...
const EarlyDiseaseDetectionAI: React.FC = () => {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative w-full min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 overflow-hidden">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="text-center p-6 bg-teal-50 rounded-xl">
                <div className="text-3xl font-bold text-teal-600 mb-2">6 months</div>
