  ...
  return (
    <div className="min-h-screen flex flex-col bg-white" role="main">
      ...
      <PortfolioHero
        ...
        description="AI-powered platform for automating, analyzing, and optimizing your social media content strategy."
        gradient="from-indigo-900 via-blue-700 to-pink-200"
        backgroundImage="/image/pages_img/Social -Media-Development.jpg"
      />
