  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="relative w-full min-h-[75vh] sm:min-h-[85vh] flex items-center justify-center bg-slate-950 overflow-hidden">
        {/* Background Image */}
        <div className="absolute inset-0 bg-[url('/image/pages_img/Predictive-Modelling.jpg')] bg-cover bg-center opacity-60 sm:opacity-70" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className={`space-y-7 order-1 lg:order-1 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
              <div className="text-left space-y-4 mb-2">
                <div className="flex flex-col items-start gap-3 sm:gap-4">
                  <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 leading-[1.15]">
                    The Power of{" "}
                    <span className="text-slate-900">Predictive Analytics</span>
                  </h2>
                </div>
              ...
              <div className="space-y-4 text-slate-800 text-base md:text-[17px] leading-relaxed text-left border-l-4 border-[#B6FF00] pl-6 font-medium">
                <p>
                  Our industry-agnostic solutions enable organizations to forecast trends, identify opportunities, and optimize operations for better business results.
                </p>
                <p>
          ...
          <div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="flex flex-col items-center gap-3 sm:gap-4">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white leading-[1.2]">
                Predictive Analytics <span className="text-white">Services</span>
              </h2>
            </div>
          ...
          <div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="flex flex-col items-center gap-3 sm:gap-4">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 leading-[1.2]">
                Predictive Analytics <span className="text-slate-900">Features</span>
              </h2>
            </div>
          ...
          <div className="relative px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 lg:gap-0 relative z-10 w-full">
              {[
                {
                  title: "Reliability",
                  desc: "Our AI models are validated for business accuracy, delivering trustworthy predictions.",
                ...
                {
                  title: "Customization",
                  desc: "Tailored models to your business workflows and unique industry needs.",
                ...
                },
                {
                  ...
                  desc: "Accelerate implementation for faster time-to-value for operational improvements.",
                ...
                },
                {
                  ...
                  desc: "Transparent models provide clear reasoning that decision-makers can trust.",
      ...
      <section className="bg-[#01010c] relative overflow-hidden py-10 sm:py-14">
        ...
        <div className="max-w-7xl mx-auto container-padding relative z-10">
          <div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="flex flex-col items-center gap-3 sm:gap-4">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white leading-[1.2]">
                Implementation <span className="text-white">Process</span>
              </h2>
            </div>
            <p className="text-sm sm:text-base md:text-lg text-slate-200 max-w-2xl mx-auto font-medium leading-relaxed">
          ...
          <div className={`mt-8 sm:mt-12 border border-white/[0.08] rounded-none overflow-hidden ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0">
              {[
                { id: "01", title: "Data Integration", desc: "Securely integrate with your business systems and prepare datasets.", color: "#B6FF00", icon: <BarChart3 className="w-8 h-8" /> },
                { id: "02", title: "Model Selection", desc: "Select the optimal architecture based on use case and industry.", color: "#B6FF00", icon: <Brain className="w-8 h-8" /> },
                { id: "03", title: "Business Validation", desc: "Rigorously train and validate models to ensure predictive accuracy.", color: "#B6FF00", icon: <CheckCircle className="w-8 h-8" /> },
                { id: "04", title: "Deployment", desc: "Seamlessly deploy into workflows with real-time monitoring.", color: "#B6FF00", icon: <Zap className="w-8 h-8" /> },
                { id: "05", title: "Optimization", desc: "Continuous improvement based on real-world business outcomes.", color: "#B6FF00", icon: <TrendingUp className="w-8 h-8" /> },
                { id: "06", title: "Governance", desc: "Implement frameworks and continuously refine for long-term success.", color: "#B6FF00", icon: <Shield className="w-8 h-8" /> }
              ].map((step, index) => (
                <div
                  key={step.id}
              ...
              {[
                {
                  ...
                  desc: "Specialized team with deep understanding of business workflows and industry regulations.",
                  color: "bg-[#B6FF00]"
                },
                {
                  num: "02",
                  title: "Enterprise-Grade Solutions",
                  desc: "Custom AI solutions designed for business environments with operational excellence.",
                  color: "bg-[#B6FF00]"
                },
                {
                  num: "03",
                  title: "Compliance & Security",
                  desc: "Enterprise-compliant architecture with robust security measures protecting business data.",
                  color: "bg-[#B6FF00]"
                },
                {
                  num: "04",
                  title: "Proven Track Record",
                  desc: "Organizations achieving improved outcomes and operational efficiency across industries.",
                  color: "bg-[#B6FF00]"
                }
              ].map((item, idx) => (
