...
const onboardingSteps = [
	{
		...
		title: 'Contact Us',
		description: 'Reach out to start the conversation. Share your business goals and chatbot needs so we can understand how AI can transform your customer interactions.',
		color: "from-green-500 to-emerald-500"
	},
	{
		icon: <Brain className="h-8 w-8" />,
		title: 'Consultation & Discovery',
		description: 'Schedule a consultation with our AI chatbot experts. We\'ll assess your needs, discuss requirements, and provide strategic recommendations.',
		color: "from-blue-500 to-indigo-500"
	},
	{
		icon: <Target className="h-8 w-8" />,
		title: 'Receive Detailed Proposal',
		description: 'Based on your requirements, we\'ll deliver a comprehensive proposal outlining the chatbot scope, implementation timeline, and transparent cost estimate.',
				...
				<div className="max-w-7xl mx-auto container-padding">
					<div className={`text-center space-y-2 mb-8 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
						...
						<p className="text-base sm:text-xl text-gray-900 max-w-3xl mx-auto px-4">
							Industry-leading AI platforms optimized for chatbot development and intelligent operations.
						</p>
					</div>
			...
			<section className="bg-[#01010c] relative overflow-hidden py-12 sm:py-16">
				...
				<div className="max-w-7xl mx-auto container-padding relative z-10">
					<div className={`text-center space-y-4 mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
						...
						<p className="text-sm sm:text-base text-gray-400 max-w-2xl mx-auto font-medium leading-relaxed">
							Simple, transparent steps to <span className="text-gray-100 font-bold">launch your AI chatbot project</span>.
						</p>
						<div className="w-24 h-1.5 bg-blue-600 mx-auto rounded-full mt-4 shadow-[0_0_15px_rgba(37,99,235,0.5)]"></div>
					</div>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
						{onboardingSteps.map((step, idx) => (
							<div
								key={idx}
								className={`relative group transition-all duration-700 ${isVisible ? 'fade-in' : 'opacity-0'}`}
