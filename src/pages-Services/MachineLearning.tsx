...
const MachineLearning: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-100 flex flex-col">
      ...
      <section className="relative w-full min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-tr from-green-50 to-blue-50">
      ...
      <section className="py-20 px-6 lg:px-8 bg-gradient-to-tr from-purple-50 to-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
               ...
               <div key={service.id} className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-8 shadow-xl border border-blue-300 flex flex-col gap-4 items-center">
      ...
      <section className="py-20 px-6 lg:px-8 bg-gradient-to-tr from-purple-50 to-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                         {/* Accuracy */}
             <div className="bg-gradient-to-br from-purple-50 to-pink-100 rounded-2xl p-8 shadow-xl border border-purple-300 flex flex-col items-center gap-4">
               <div className="flex-shrink-0 w-14 h-14 bg-purple-200 rounded-xl flex items-center justify-center mb-2 mx-auto">
               ...
               <p className="text-gray-800 text-center">High-precision predictions and classifications for reliable decision-making.</p>
             </div>
             {/* Scalability */}
             <div className="bg-gradient-to-br from-blue-50 to-cyan-100 rounded-2xl p-8 shadow-xl border border-blue-300 flex flex-col items-center gap-4">
               <div className="flex-shrink-0 w-14 h-14 bg-blue-200 rounded-xl flex items-center justify-center mb-2 mx-auto">
             ...
             {/* Flexibility */}
             <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl p-8 shadow-xl border border-green-300 flex flex-col items-center gap-4">
               <div className="flex-shrink-0 w-14 h-14 bg-green-200 rounded-xl flex items-center justify-center mb-2 mx-auto">
             ...
             {/* Automation */}
             <div className="bg-gradient-to-br from-orange-50 to-amber-100 rounded-2xl p-8 shadow-xl border border-orange-300 flex flex-col items-center gap-4">
               <div className="flex-shrink-0 w-14 h-14 bg-orange-200 rounded-xl flex items-center justify-center mb-2 mx-auto">
               ...
               <p className="text-gray-800 text-center">Automate complex processes and decision-making workflows.</p>
             </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 lg:px-8 bg-gradient-to-tr from-purple-50 to-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                         {/* Define the use case */}
             <div className="bg-gradient-to-br from-indigo-50 to-purple-100 rounded-2xl p-8 shadow-xl border border-indigo-300 flex flex-col items-center gap-4">
               <span className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-indigo-200 text-indigo-600 mb-2">
               ...
               <p className="text-gray-800 text-center">Pinpoint your business challenge to maximize machine learning impact.</p>
             </div>
             {/* Data collection & preparation */}
             <div className="bg-gradient-to-br from-teal-50 to-cyan-100 rounded-2xl p-8 shadow-xl border border-teal-300 flex flex-col items-center gap-4">
               <span className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-teal-200 text-teal-600 mb-2">
                 <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
               ...
               <p className="text-gray-800 text-center">Curate high-quality data for optimal model performance.</p>
             </div>
             {/* Development & integration */}
             <div className="bg-gradient-to-br from-blue-50 to-sky-100 rounded-2xl p-8 shadow-xl border border-blue-300 flex flex-col items-center gap-4">
               <span className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-blue-200 text-blue-600 mb-2">
                 <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
               ...
               <p className="text-gray-800 text-center">Build and train machine learning models for your applications.</p>
             </div>
             {/* Deployment & monitoring */}
             <div className="bg-gradient-to-br from-amber-50 to-yellow-100 rounded-2xl p-8 shadow-xl border border-amber-300 flex flex-col items-center gap-4">
               <span className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-amber-200 text-amber-600 mb-2">
                 <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <section className="py-20 px-6 lg:px-8 bg-gradient-to-tr from-purple-50 to-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                         {/* Expertise */}
             <div className="bg-gradient-to-br from-violet-50 to-purple-100 rounded-2xl p-8 shadow-xl border border-violet-300 flex flex-col items-center gap-4">
               <span className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-violet-200 text-violet-600 mb-2">
                 <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
             ...
             {/* Custom Solutions */}
             <div className="bg-gradient-to-br from-emerald-50 to-green-100 rounded-2xl p-8 shadow-xl border border-emerald-300 flex flex-col items-center gap-4">
               <span className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-emerald-200 text-emerald-600 mb-2">
                 <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
               ...
               <p className="text-gray-800 text-center">Bespoke machine learning integrations for your unique business goals.</p>
             </div>
             {/* End-to-End Support */}
             <div className="bg-gradient-to-br from-sky-50 to-blue-100 rounded-2xl p-8 shadow-xl border border-sky-300 flex flex-col items-center gap-4">
               <span className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-sky-200 text-sky-600 mb-2">
                 <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
             ...
             {/* Proven Results */}
             <div className="bg-gradient-to-br from-rose-50 to-pink-100 rounded-2xl p-8 shadow-xl border border-rose-300 flex flex-col items-center gap-4">
               <span className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-rose-200 text-rose-600 mb-2">
                 <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
