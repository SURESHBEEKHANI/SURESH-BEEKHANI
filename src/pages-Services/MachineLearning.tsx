      ...
      <section className="py-8 sm:py-10 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto container-padding">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="text-left space-y-3 sm:space-y-4 mb-10">
                <div className="flex flex-col items-start gap-3 sm:gap-4">
                  <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-[#050729] leading-[1.2]">
                    The Power of <span className="text-[#ff0ea3]">Machine Learning</span>
                  </h2>
                </div>
            ...
            {/* Right: ML Image with floating effect */}
          ...
          <div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="flex flex-col items-center gap-3 sm:gap-4">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white leading-[1.2]">
                Machine Learning <span className="text-[#ff0ea3]">Solutions</span>
              </h2>
            </div>
          ...
          <div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="flex flex-col items-center gap-3 sm:gap-4">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 leading-[1.2]">
                Machine Learning <span className="text-[#ff0ea3]">Benefits</span>
              </h2>
            </div>
      ...
      <section className="bg-[#01010c] relative overflow-hidden py-8 sm:py-10">
        ...
        <div className="max-w-7xl mx-auto container-padding relative z-10">
          <div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="flex flex-col items-center gap-3 sm:gap-4">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white leading-[1.2]">
                ML Implementation <span className="text-[#ff0ea3]">Process</span>
              </h2>
            </div>
          ...
          <div className={`mt-8 sm:mt-12 border border-white/25 rounded-none overflow-hidden ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0">
              {[
                { id: "01", title: "Business Assessment", desc: "Identify workflows where ML delivers maximum operational impact.", color: "#e23126", icon: <Brain className="w-8 h-8" /> },
                { id: "02", title: "Secure Data Integration", desc: "Secure data preparation and system integration for training robust ML models.", color: "#9068d4", icon: <Zap className="w-8 h-8" /> },
                { id: "03", title: "Validation & Testing", desc: "ML models trained and rigorously tested to ensure accuracy and alignment.", color: "#3eb37c", icon: <CheckCircle className="w-8 h-8" /> },
                { id: "04", title: "ML Model Development", desc: "Build and validate ML models with stakeholders and industry standards.", color: "#3b82f6", icon: <Cpu className="w-8 h-8" /> },
