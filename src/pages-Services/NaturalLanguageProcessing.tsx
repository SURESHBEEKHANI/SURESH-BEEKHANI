  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="relative w-full min-h-[75vh] sm:min-h-[85vh] flex items-center justify-center bg-slate-950 overflow-hidden">
        {/* Background Image */}
        <div className="absolute inset-0 bg-[url('/image/pages_img/Natural-Language-Processing.jpg')] bg-cover bg-center opacity-60 sm:opacity-70" />
              ...
              <div className="text-left space-y-4 mb-2">
                <div className="flex flex-col items-start gap-3 sm:gap-4">
                  <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 leading-[1.15]">
                    The Power of{" "}
                    <span className="text-slate-900">Natural Language Processing</span>
                  </h2>
                </div>
          ...
          <div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="flex flex-col items-center gap-3 sm:gap-4">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white leading-[1.2]">
                NLP <span className="text-white">Solutions</span>
              </h2>
            </div>
          ...
          <div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="flex flex-col items-center gap-3 sm:gap-4">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 leading-[1.2]">
                NLP <span className="text-slate-900">Benefits</span>
              </h2>
            </div>
          ...
          <div className="relative px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 lg:gap-0 relative z-10 w-full">
              {[
                {
                  title: "Understanding",
                  desc: "NLP interprets context, sentiment, and intent from text for accurate, intelligent responses and analysis.",
                ...
                {
                  title: "Scalability",
                  desc: "NLP scales from startups to enterprises, handling millions of documents and customer interactions.",
                ...
                {
                  title: "Efficiency",
                  desc: "Automate text processing, document analysis, and customer communication, reducing costs and improving speed.",
      ...
      <section className="bg-[#01010c] relative overflow-hidden py-10 sm:py-14">
        ...
        <div className="max-w-7xl mx-auto container-padding relative z-10">
          <div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="flex flex-col items-center gap-3 sm:gap-4">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white leading-[1.2]">
                NLP Implementation <span className="text-white">Process</span>
              </h2>
            </div>
            <p className="text-sm sm:text-base md:text-lg text-slate-200 max-w-2xl mx-auto font-medium leading-relaxed">
          ...
          <div className={`mt-8 sm:mt-12 border border-white/[0.08] rounded-none overflow-hidden ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0">
              {[
                { id: "01", title: "Business Assessment", desc: "Identify workflows where NLP delivers maximum operational impact.", color: "#B6FF00", icon: <Target className="w-8 h-8" /> },
                { id: "02", title: "Secure Data Integration", desc: "Secure data preparation and system integration for training robust NLP models.", color: "#B6FF00", icon: <Shield className="w-8 h-8" /> },
                { id: "03", title: "Validation & Testing", desc: "NLP models trained and rigorously tested to ensure accuracy and alignment.", color: "#B6FF00", icon: <CheckCircle className="w-8 h-8" /> },
                { id: "04", title: "NLP Model Development", desc: "Build and validate NLP models with stakeholders and industry standards.", color: "#B6FF00", icon: <Cpu className="w-8 h-8" /> },
                ...
                { id: "06", title: "Governance & Improvement", desc: "Implement governance frameworks and continuously refine for long-term success.", color: "#B6FF00", icon: <BarChart3 className="w-8 h-8" /> }
              ].map((step, index) => (
                <div
                  key={step.id}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className={`space-y-6 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
              {[
                {
                  num: "01",
                  title: "Deep NLP Expertise",
                  desc: "Specialized team with extensive experience in language processing, text analytics, and conversational AI.",
                  color: "bg-[#B6FF00]"
                },
                {
                  num: "02",
                  title: "Custom Solutions",
                  desc: "Tailored NLP solutions designed specifically for your business challenges, workflows, and industry requirements.",
                  color: "bg-[#B6FF00]"
                },
                {
                  num: "03",
                  title: "Enterprise Security",
                  desc: "Robust security measures and compliance with industry standards (GDPR, SOC 2) protecting your business data.",
                  color: "bg-[#B6FF00]"
                },
                {
                  num: "04",
                  title: "Proven Track Record",
                  desc: "Organizations achieving improved efficiency, reduced costs, and enhanced customer engagement.",
                  color: "bg-[#B6FF00]"
                }
              ].map((item, idx) => (
