...
import { Eye, Target, Users, Video, FileText, Brain, ArrowRight, CheckCircle, Shield, Globe, Zap, MessageSquare, Mail, TrendingUp, Plus, Minus, Cpu } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="relative w-full min-h-[75vh] sm:min-h-[85vh] flex items-center justify-center bg-slate-950 overflow-hidden">
        {/* Background Image */}
        <div className="absolute inset-0 bg-[url('/image/pages_img/Computer-Vision.avif')] bg-cover bg-center opacity-60 sm:opacity-70" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className={`space-y-7 order-1 lg:order-1 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
              <div className="text-left space-y-4 mb-2">
                <div className="flex flex-col items-start gap-3 sm:gap-4">
                  <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 leading-[1.15]">
                    The Power of{" "}
                    <span className="text-slate-900">Computer Vision</span>
                  </h2>
                </div>
              ...
              <div className="space-y-4 text-slate-800 text-base md:text-[17px] leading-relaxed text-left border-l-4 border-[#B6FF00] pl-6 font-medium">
                <p>
                  Our AI-powered solutions enable organizations to analyze images and video, detect patterns, automate visual tasks, and extract actionable insights with unprecedented accuracy and speed.
                </p>
                <p>
          ...
          <div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="flex flex-col items-center gap-3 sm:gap-4">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white leading-[1.2]">
                Computer Vision <span className="text-white">Services</span>
              </h2>
            </div>
          ...
          <div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="flex flex-col items-center gap-3 sm:gap-4">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 leading-[1.2]">
                Computer Vision <span className="text-slate-900">Benefits</span>
              </h2>
            </div>
          ...
          <div className="relative px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 lg:gap-0 relative z-10 w-full">
              {[
                {
                  title: "Accuracy",
                  desc: "AI-powered precision in visual analysis, reducing errors and improving quality control.",
                ...
                {
                  title: "Speed",
                  desc: "Accelerate visual analysis and decision-making, processing thousands of images in seconds.",
                ...
                {
                  title: "Security",
                  desc: "Secure, compliant AI solutions protecting sensitive data with encryption and access controls.",
                ...
                {
                  title: "Cost Savings",
                  desc: "Automate visual tasks, reduce manual labor, and lower operational costs while improving quality.",
        ...
        <div className="max-w-7xl mx-auto container-padding relative z-10">
          ...
          <div className={`mt-8 sm:mt-12 border border-white/[0.08] rounded-none overflow-hidden ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0">
              {[
                { id: "01", title: "Business Assessment", desc: "Identify workflows where computer vision delivers maximum operational impact.", color: "#B6FF00", icon: <Brain className="w-8 h-8" /> },
                { id: "02", title: "Secure Design", desc: "Design robust, scalable vision architecture ensuring data security and compliance.", color: "#B6FF00", icon: <Shield className="w-8 h-8" /> },
                { id: "03", title: "Validation & Testing", desc: "Vision models trained and rigorously tested to ensure accuracy and alignment.", color: "#B6FF00", icon: <CheckCircle className="w-8 h-8" /> },
                ...
                { id: "05", title: "Change Management", desc: "Empower your team with training and support for smooth adoption of AI vision tools.", color: "#B6FF00", icon: <Users className="w-8 h-8" /> },
              ...
              {[
                {
                  ...
                  desc: "Specialized team with deep understanding of visual AI, object detection, and image processing.",
                  color: "bg-[#B6FF00]"
                },
                {
                  num: "02",
                  title: "Custom Solutions",
                  desc: "Tailored computer vision solutions designed for your specific business challenges and requirements.",
                  color: "bg-[#B6FF00]"
                },
                {
                  num: "03",
