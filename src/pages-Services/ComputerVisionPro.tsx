    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-blue-100 flex flex-col">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-24">
          <div className="text-white space-y-6 sm:space-y-8">
            ...
            <p className="text-sm sm:text-base md:text-lg text-white font-medium leading-relaxed max-w-4xl drop-shadow-md">
              Transform your business with intelligent computer vision solutions for automation, analytics, and visual intelligence across all industries.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto container-padding">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            >
              ...
              <h3 className="font-bold text-sm sm:text-base text-white mb-2 text-center w-full">Object Detection & Tracking</h3>
              <p className="text-xs sm:text-sm font-medium text-gray-300 text-center leading-relaxed">Detect, classify, and track objects in images and video streams for security, inventory, and quality control applications.</p>
            </div>
            ...
            >
              ...
              <h3 className="font-bold text-sm sm:text-base text-white mb-2 text-center w-full">Facial Recognition & Analysis</h3>
              <p className="text-xs sm:text-sm font-medium text-gray-300 text-center leading-relaxed">Secure authentication, access control, and customer analytics with advanced facial recognition technology.</p>
            </div>
            ...
            >
              ...
              <h3 className="font-bold text-sm sm:text-base text-white mb-2 text-center w-full">Image Classification & Tagging</h3>
              <p className="text-xs sm:text-sm font-medium text-gray-300 text-center leading-relaxed">Automatically categorize and tag images for e-commerce, content management, and digital asset organization.</p>
            </div>
            ...
            >
              ...
              <h3 className="font-bold text-sm sm:text-base text-white mb-2 text-center w-full">Document Processing & OCR</h3>
              <p className="text-xs sm:text-sm font-medium text-gray-300 text-center leading-relaxed">Extract text and data from documents, invoices, receipts, and forms with high-accuracy optical character recognition.</p>
            </div>
            ...
            >
              ...
              <h3 className="font-bold text-sm sm:text-base text-white mb-2 text-center w-full">Quality Inspection & Defect Detection</h3>
              <p className="text-xs sm:text-sm font-medium text-gray-300 text-center leading-relaxed">Automated visual inspection for manufacturing quality control, defect detection, and compliance verification.</p>
            </div>
            ...
            >
              ...
              <h3 className="font-bold text-sm sm:text-base text-white mb-2 text-center w-full">Video Analytics & Surveillance</h3>
              <p className="text-xs sm:text-sm font-medium text-gray-300 text-center leading-relaxed">Real-time video analysis for security monitoring, crowd detection, behavior analysis, and anomaly detection.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto container-padding">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className={`modern-card p-6 sm:p-8 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px] hover:scale-105 transition-all duration-300 ${isVisible ? 'scale-in' : 'opacity-0'}`}>
              ...
              <p className="text-xs sm:text-sm text-gray-900 text-center leading-relaxed">AI-powered precision in visual analysis, reducing errors and improving quality control across operations.</p>
            </div>
            {/* Faster Processing */}
            <div className={`modern-card p-6 sm:p-8 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px] hover:scale-105 transition-all duration-300 ${isVisible ? 'scale-in' : 'opacity-0'}`} style={{ animationDelay: '0.1s' }}>
              ...
              <h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-2 text-center w-full">Faster Processing</h3>
              <p className="text-xs sm:text-sm text-gray-900 text-center leading-relaxed">Accelerate visual analysis and decision-making, processing thousands of images in seconds for real-time insights.</p>
            </div>
            {/* Enterprise Security */}
            <div className={`modern-card p-6 sm:p-8 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px] hover:scale-105 transition-all duration-300 ${isVisible ? 'scale-in' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
              ...
              <p className="text-xs sm:text-sm text-gray-900 text-center leading-relaxed">Secure, compliant AI solutions protecting sensitive data with encryption and access controls.</p>
            </div>
            {/* Cost Reduction */}
            <div className={`modern-card p-6 sm:p-8 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px] hover:scale-105 transition-all duration-300 ${isVisible ? 'scale-in' : 'opacity-0'}`} style={{ animationDelay: '0.3s' }}>
              ...
              <p className="text-xs sm:text-sm text-gray-900 text-center leading-relaxed">Automate visual tasks, reduce manual labor, and lower operational costs while improving quality and consistency.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto container-padding">
          <div className={`text-center space-y-2 mb-8 sm:mb-8 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
            ...
            <p className="text-base sm:text-xl text-gray-300 max-w-3xl mx-auto px-4">
              Proven methodology for deploying secure, intelligent computer vision solutions in business environments.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {/* Business Assessment */}
            <div className={`modern-card p-6 sm:p-8 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px] hover:scale-105 transition-all duration-300 ${isVisible ? 'scale-in' : 'opacity-0'}`}>
              ...
              <p className="text-xs sm:text-sm text-gray-300 text-center leading-relaxed">Identify workflows and business challenges where computer vision delivers maximum operational impact.</p>
            </div>
            {/* Data Integration */}
            <div className={`modern-card p-6 sm:p-8 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px] hover:scale-105 transition-all duration-300 ${isVisible ? 'scale-in' : 'opacity-0'}`} style={{ animationDelay: '0.1s' }}>
              ...
              <p className="text-xs sm:text-sm text-gray-300 text-center leading-relaxed">Secure integration with existing systems and databases for training robust computer vision models.</p>
            </div>
            ...
            <div className={`modern-card p-6 sm:p-8 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px] hover:scale-105 transition-all duration-300 ${isVisible ? 'scale-in' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
              ...
              <p className="text-xs sm:text-sm text-gray-300 text-center leading-relaxed">Build and validate computer vision models with stakeholders and industry standards.</p>
            </div>
            ...
            <div className={`modern-card p-6 sm:p-8 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px] hover:scale-105 transition-all duration-300 ${isVisible ? 'scale-in' : 'opacity-0'}`} style={{ animationDelay: '0.3s' }}>
              ...
              <p className="text-xs sm:text-sm text-gray-300 text-center leading-relaxed">Seamless integration into workflows with ongoing monitoring and performance optimization.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-tr from-purple-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-3 sm:space-y-4 mb-8 sm:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">Why Choose Us for Computer Vision</h2>
            <div className="flex justify-center">
              <div className="w-12 sm:w-16 h-1 sm:h-1.5 bg-gradient-to-r from-blue-500 to-blue-700 rounded-full"></div>
            </div>
            <p className="text-base sm:text-xl text-gray-800 max-w-3xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="bg-gradient-to-br from-cyan-50 to-blue-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-xl border border-cyan-200 flex flex-col items-center gap-3 sm:gap-4">
              ...
              <span className="font-bold text-gray-900 text-base sm:text-lg text-center">Computer Vision Expertise</span>
              <p className="text-xs sm:text-sm text-gray-900 text-center leading-relaxed">Specialized team with deep understanding of visual AI, object detection, image processing, and industry applications.</p>
            </div>
            {/* Custom Solutions */}
            <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-xl border border-green-200 flex flex-col items-center gap-3 sm:gap-4">
              ...
              <p className="text-xs sm:text-sm text-gray-900 text-center leading-relaxed">Tailored computer vision solutions designed for your specific business challenges and operational requirements.</p>
            </div>
            {/* Enterprise Security */}
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-xl border border-blue-200 flex flex-col items-center gap-3 sm:gap-4">
              ...
              <span className="font-bold text-gray-900 text-base sm:text-lg text-center">Enterprise Security</span>
              <p className="text-xs sm:text-sm text-gray-900 text-center leading-relaxed">Robust security measures and compliance with industry standards protecting your business data.</p>
            </div>
            {/* Proven Results */}
            <div className="bg-gradient-to-br from-yellow-50 to-orange-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-xl border border-yellow-200 flex flex-col items-center gap-3 sm:gap-4">
              ...
              <span className="font-bold text-gray-900 text-base sm:text-lg text-center">Proven Track Record</span>
              <p className="text-xs sm:text-sm text-gray-900 text-center leading-relaxed">Organizations achieving improved accuracy, reduced costs, and enhanced operational efficiency.</p>
            </div>
          </div>
        </div>
      </section>
