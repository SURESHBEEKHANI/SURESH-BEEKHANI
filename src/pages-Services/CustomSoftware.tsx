...
import { Brain, Code, Zap, Target, Users, TrendingUp, Shield, Globe, ArrowRight, CheckCircle, MessageSquare, BarChart3, Eye, Bot, Mail, Phone, MapPin, Clock, Cpu, Network, Workflow, Plus, Minus, Server, Settings, Link2, MonitorPlay, ShoppingCart, Layout } from "lucide-react";
...
const customSoftwareServices = [
	{
		...
		description: "Custom software designed for large organizations to enhance workflow efficiency, streamline operations, and improve decision-making with enterprise-grade stability.",
	...
	},
	{
		...
		description: "Feature-rich software-as-a-service platforms that users can access remotely, supporting subscription-based business models and scalable infrastructure.",
	...
	},
	{
		...
		description: "Secure applications compliant with HIPAA regulations, ensuring confidentiality and protection of medical data through advanced encryption and security measures.",
	...
	},
	{
		...
		description: "Tailored e-commerce platforms with shopping carts, secure payment gateways, inventory management, and customer portals for a seamless shopping experience.",
	...
	},
	{
		...
		description: "Seamless integration with external systems, APIs, and third-party applications to enhance functionality and streamline operations across your entire tech stack.",
	...
	},
	{
		...
		description: "Enterprise Resource Planning software that centralizes finance, HR, inventory, and other critical business functions into a single, cohesive dashboard.",
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 flex flex-col">
			...
			<section className="relative w-full min-h-[60vh] sm:min-h-[70vh] flex items-center justify-center hero-bg overflow-hidden">
				<div className="absolute inset-0 opacity-20 bg-[url('/image/pages_img/IT-Software.jpg')] bg-cover bg-center" />
				<div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
					<div className="text-white space-y-6 sm:space-y-8">
						...
						<p className="text-sm sm:text-base md:text-lg text-white font-medium leading-relaxed max-w-4xl drop-shadow-md">
							Unlock your business’s full potential with our Custom Software Development Services. <br />
							We deliver tailored digital solutions designed to boost efficiency, streamline operations, and drive measurable growth.
						</p>
					</div>
				</div>
			</section>
							...
							<div className="text-left space-y-3 sm:space-y-4 mb-10">
								<div className="flex flex-col items-start gap-3 sm:gap-4">
									<h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-[#050729] leading-[1.2]">
										Revolutionize Your Business with <span className="text-[#ff0ea3]">Custom Software</span>
									</h2>
								</div>
								<p className="text-xs sm:text-sm md:text-base text-gray-600 max-w-3xl font-medium leading-relaxed">
									Bridge the gap between vision and reality with bespoke software solutions tailored to your unique organizational needs.
								</p>
							</div>

							<div className="space-y-4 text-slate-600 text-lg leading-relaxed text-left">
								<p>
									Velnix Solutions is a leading custom software development company, providing specialized services for organizations of all sizes. Our team of experts follows a rigorous development process to design, build, deploy, and maintain software solutions tailored to each client's unique requirements.
								</p>
								<p>
									We focus on both custom-built solutions and modifications to commercial off-the-shelf software, enabling fully personalized experiences for your business. With a global presence, we rapidly deliver high-quality custom software solutions that help businesses achieve their digital goals and gain a competitive edge.
								</p>
							</div>
						...
						<div className={`relative flex justify-center lg:justify-end order-2 lg:order-2 ${isVisible ? 'slide-right' : 'opacity-0'}`}>
							<div className="relative group">
								...
								<div className="relative overflow-hidden rounded-none shadow-2xl border border-slate-100">
									<img
										src="/image/pages_img/IT-Software.jpg"
					...
					<div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
						<div className="flex flex-col items-center gap-3 sm:gap-4">
							<h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white leading-[1.2]">
								Our Development <span className="text-[#ff0ea3]">Expertise</span>
							</h2>
						</div>
						<p className="text-xs sm:text-sm md:text-base text-gray-300 max-w-3xl mx-auto font-medium leading-relaxed">
							Comprehensive software development services designed to drive operational excellence and business growth.
						</p>
					</div>
					...
					<div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
						<div className="flex flex-col items-center gap-3 sm:gap-4">
							<h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 leading-[1.2]">
								Strategic <span className="text-[#ff0ea3]">Advantages</span>
							</h2>
						</div>
						<p className="text-xs sm:text-sm md:text-base text-slate-600 max-w-3xl mx-auto font-medium leading-relaxed">
							Unlocking long-term value through tailored digital transformation and architectural precision.
						</p>
					</div>
					...
					<div className="relative px-4">
						...
						<div className="grid grid-cols-1 lg:grid-cols-4 gap-16 lg:gap-0 relative z-10 w-full">
							{[
								{
									title: "Customization",
									desc: "Software built exactly for your workflows, not a generic product that forces you to adapt.",
								...
								{
									title: "Scalability",
									desc: "Future-proof solutions that grow with your business without per-user licensing bottlenecks.",
								...
								{
									title: "Efficiency",
									desc: "Seamless automation of manual tasks that significantly boosts team productivity and ROI.",
								...
								{
									title: "Integration",
									desc: "Native connectivity with your existing tech ecosystem for a unified operational flow.",
			...
			{/* Custom Software Implementation Process Section (Pill-Style Infographic) */}
				...
				<div className="max-w-7xl mx-auto container-padding relative z-10">
					<div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
						...
						<p className="text-xs sm:text-sm md:text-base text-gray-400 max-w-3xl mx-auto font-medium leading-relaxed">
							Our systematic approach to building high-performance, secure, and user-centric software solutions.
						</p>
					</div>
					...
					<div className={`mt-8 sm:mt-12 border border-white/25 rounded-none overflow-hidden ${isVisible ? 'fade-in' : 'opacity-0'}`}>
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0">
							{[
								{ id: "01", title: "Discovery & Planning", desc: "We analyze your current operations to identify pain points and high-impact software requirements that drive ROI.", color: "#e23126", icon: <Eye className="w-8 h-8" /> },
								{ id: "02", title: "Design & Architecture", desc: "System architects design a robust, scalable system architecture and intuitive UX to ensure long-term stability and user adoption.", color: "#9068d4", icon: <Layout className="w-8 h-8" /> },
								{ id: "03", title: "Agile Development", desc: "We build your solution in transparent 2-week sprints, ensuring continuous delivery and immediate feedback loops.", color: "#3eb37c", icon: <Code className="w-8 h-8" /> },
								{ id: "04", title: "QA & Security Testing", desc: "Rigorous testing for bugs, performance bottlenecks, and security vulnerabilities to guarantee a rock-solid production release.", color: "#3b82f6", icon: <Shield className="w-8 h-8" /> },
								{ id: "05", title: "Deployment & Training", desc: "We launch your software and empower your team with training and documentation for seamless integration into daily operations.", color: "#f39c12", icon: <Zap className="w-8 h-8" /> },
								{ id: "06", title: "Support & Optimization", desc: "Continuous monitoring and iterative updates to ensure your software remains efficient, secure, and focused on your goals.", color: "#ff0ea3", icon: <Settings className="w-8 h-8" /> }
							].map((step, index) => (
								<div
									key={step.id}
				...
				<div className="max-w-7xl mx-auto container-padding relative z-10">
					<div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
						...
						<p className="text-xs sm:text-sm md:text-base text-slate-500 max-w-3xl mx-auto font-medium leading-relaxed">
							Technical excellence and strategic partnership focused on delivering high-impact software solutions.
						</p>
					</div>
							...
							<div className="relative rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-slate-100">
								...
								<div className="absolute bottom-10 left-10 text-white z-20">
									<div className="bg-white/10 backdrop-blur-md px-6 py-3 rounded-none border border-white/20">
										...
										<p className="text-xl font-black tracking-tighter">BUILD SMARTER.</p>
									</div>
								</div>
							</div>
								...
								{[
									{
										...
										desc: "Our specialized team understands modern front-end, back-end, and database technologies, ensuring high-performance software built with industry best practices.",
										bgColor: "bg-[#e23126]",
									...
									},
									{
										...
										desc: "We use 2-week sprints to provide continuous delivery and complete transparency, allowing for rapid iterations and alignment with your goals.",
										bgColor: "bg-[#9068d4]",
									...
									},
									{
										...
										desc: "Security and ownership are paramount. Upon completion, you assume total ownership of the source code and all intellectual property rights.",
										bgColor: "bg-[#3eb37c]",
									...
									},
									{
										...
										desc: "With a proven track record across healthcare, e-commerce, and enterprise sectors, we bring deep domain knowledge to every project.",
										bgColor: "bg-[#f59e0b]",
				...
				steps={[
					{
						...
						title: 'Contact Us',
						description: 'Reach out to start the conversation. Share your software vision and requirements so we can understand your goals and how best to support you.',
						color: "from-green-500 to-emerald-500"
					},
					{
						icon: <Brain className="h-8 w-8" />,
						title: 'Discovery & Consultation',
						description: 'Schedule a discovery session with our software experts. We\'ll discuss your project in detail, assess feasibility, and provide strategic recommendations.',
						color: "from-blue-500 to-indigo-500"
					},
					{
						icon: <Target className="h-8 w-8" />,
						title: 'Get a Detailed Proposal',
						description: 'Based on your requirements, we\'ll deliver a comprehensive proposal outlining the project scope, tech stack, timeline, and cost estimate.',
						color: "from-yellow-500 to-amber-500"
					},
					{
						icon: <Zap className="h-8 w-8" />,
						title: 'Deployment & Launch',
						description: 'Once approved, our team builds and launches your project with rigorous testing, team training, and seamless system integration.',
				...
				<div className="max-w-4xl mx-auto">
					<div className="text-center space-y-3 sm:space-y-4 mb-10 sm:mb-14">
						...
						<p className="text-xs sm:text-sm md:text-base text-gray-600 max-w-3xl mx-auto font-medium leading-relaxed">
							Common questions about our custom software development lifecycle and post-launch support.
						</p>
					</div>
					{/* FAQ Accordion */}
