...
import { Brain, Code, Zap, Target, Users, TrendingUp, Shield, Globe, ArrowRight, CheckCircle, MessageSquare, BarChart3, Eye, Bot, Mail, Phone, MapPin, Clock, Cpu, Network, Workflow, Plus, Minus, Layout, Smartphone, ShoppingCart, Server, Monitor } from "lucide-react";
...
const webServices = [
	{
		...
		description: "We build bespoke, high-performance websites tailored to your unique brand identity and business objectives, ensuring a superior user experience and optimal functionality.",
	...
	},
	{
		...
		description: "Develop robust, scalable, and secure web applications using cutting-edge frameworks like React, Node.js, and Python, designed to handle complex business logic.",
	...
	},
	{
		...
		description: "Create seamless, conversion-optimized e-commerce platforms with secure payment gateways, inventory management, and intuitive shopping experiences.",
	...
	},
	{
		...
		description: "Implement highly customizable Content Management Systems (CMS) that empower your team to effortlessly manage, update, and publish digital content.",
	...
	},
	{
		id: 5,
		title: "UI/UX Design",
		description: "Craft visually stunning, user-centric interfaces with intuitive navigation, engaging micro-animations, and modern aesthetic principles that wow your audience.",
	...
	},
	{
		...
		description: "Ensure your digital presence remains flawless with ongoing server monitoring, security updates, performance optimization, and dedicated technical support.",
...
const faqData = [
	{
		...
		answer: "We utilize modern, industry-standard technologies including React, Next.js, Vue.js for the frontend, and Node.js, Python, or robust cloud architectures for the backend, ensuring scalable and performant solutions.",
	},
	{
				...
				<div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
					<div className="text-white space-y-6 sm:space-y-8">
						...
						<p className="text-sm sm:text-base md:text-lg text-white font-medium leading-relaxed max-w-4xl drop-shadow-md">
							Crafting high-performance, dynamic, and visually stunning web experiences <br /> that captivate users, drive conversions, and elevate your digital brand.
						</p>
					</div>
				</div>
			</section>
							...
							<div className="text-left space-y-3 sm:space-y-4 mb-10">
								<div className="flex flex-col items-start gap-3 sm:gap-4">
									<h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-[#050729] leading-[1.2]">
										Next-Gen <span className="text-[#ff0ea3]">Web Solutions</span>
									</h2>
								</div>
								<p className="text-xs sm:text-sm md:text-base text-gray-600 max-w-3xl font-medium leading-relaxed">
									We transform your vision into an interactive, lightning-fast digital reality that stands out in today's competitive online landscape.
								</p>
							</div>

							<div className="space-y-4 text-slate-600 text-lg leading-relaxed text-left">
								<p>
									Your website is the digital storefront of your business. We engineer bespoke web solutions that merge breathtaking design with robust functionality, creating immersive user journeys.
								</p>
								<p>
									From responsive corporate platforms to complex web applications, our development team leverages the latest tech stacks to ensure your online presence is secure, scalable, and optimized for unparalleled performance across all devices.
								</p>
							</div>
					...
					<div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
						<div className="flex flex-col items-center gap-3 sm:gap-4">
							<h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white leading-[1.2]">
								Our Web <span className="text-[#ff0ea3]">Services</span>
							</h2>
						</div>
						<p className="text-xs sm:text-sm md:text-base text-gray-300 max-w-3xl mx-auto font-medium leading-relaxed">
							Comprehensive web development services designed to scale your business digitally.
						</p>
					</div>
					...
					<div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
						<div className="flex flex-col items-center gap-3 sm:gap-4">
							<h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 leading-[1.2]">
								Why Invest in <span className="text-[#ff0ea3]">Premium Web Dev?</span>
							</h2>
						</div>
						<p className="text-xs sm:text-sm md:text-base text-slate-600 max-w-3xl mx-auto font-medium leading-relaxed">
							Unlock your ultimate digital potential through well-structured, modern web architectures.
						</p>
					</div>
					...
					<div className="relative px-4">
						...
						<div className="grid grid-cols-1 lg:grid-cols-4 gap-16 lg:gap-0 relative z-10 w-full">
							{[
								{
									title: "Global Reach",
									desc: "Break geographical boundaries and reach customers anywhere instantly with a 24/7 digital presence.",
								...
								},
								{
									...
									desc: "Engage visitors with fluid layouts, intuitive navigation, and fast load times that reduce bounce rates.",
								...
								{
									title: "Scalability",
									desc: "Future-proof frameworks that effortlessly process growing traffic and feature expansions.",
								...
								},
								{
									...
									desc: "Advanced protocols, secure authentication, and data encryption protecting your business assets.",
				...
				<div className="max-w-7xl mx-auto container-padding relative z-10">
					<div className={`text-center space-y-3 sm:space-y-4 mb-10 sm:mb-12 md:mb-16 ${isVisible ? 'fade-in' : 'opacity-0'}`}>
						...
						<p className="text-xs sm:text-sm md:text-base text-slate-500 max-w-3xl mx-auto font-medium leading-relaxed">
							Delivering digital excellence that defines the industry standard.
						</p>
					</div>
							...
							<div className="relative rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-slate-100">
								...
								<div className="absolute bottom-10 left-10 text-white z-20">
									<div className="bg-white/10 backdrop-blur-md px-6 py-3 rounded-none border border-white/20">
										<p className="text-xl font-black tracking-tighter">BUILD BETTER.</p>
									</div>
								</div>
							</div>
								...
								{[
									{
										...
										desc: "We interlace stunning aesthetics with robust backend engineering, ensuring your website is both beautiful and hyper-functional.",
										bgColor: "bg-[#e23126]",
									...
									},
									{
										...
										desc: "Continuous delivery, transparent milestones, and sprint-based development so you see your product evolve in real-time.",
										bgColor: "bg-[#9068d4]",
									...
									},
									{
										...
										desc: "Rigorous cross-browser testing, accessibility compliance, and performance profiling prior to any launch.",
										bgColor: "bg-[#3eb37c]",
									...
									},
									{
										...
										desc: "We don't just launch and leave. We provide ongoing support, maintenance, and strategic planning for continuous digital growth.",
										bgColor: "bg-[#f59e0b]",
				...
				steps={[
					{
						...
						description: 'We learn about your brand, audience, and goals to plot a strategic roadmap for your digital presence.',
						color: "from-green-500 to-emerald-500"
					},
					{
						icon: <Target className="h-8 w-8" />,
						title: 'UI/UX Design',
						description: 'Our designers construct interactive wireframes and high-fidelity mockups representing the final aesthetic.',
						color: "from-blue-500 to-indigo-500"
					},
					{
						icon: <Code className="h-8 w-8" />,
						title: 'Development & Engineering',
						description: 'Our developers bring the designs to life using clean, scalable code and the best framework suited for your needs.',
						color: "from-yellow-500 to-amber-500"
					},
					{
						icon: <Zap className="h-8 w-8" />,
						title: 'Testing & Launch',
						description: 'Comprehensive QA testing guarantees performance prior to seamless deployment to your live server.',
