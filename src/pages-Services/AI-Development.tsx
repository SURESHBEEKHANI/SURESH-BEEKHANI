					...
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
						...
						<div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 shadow-lg border border-blue-100">
							<div className="flex flex-col items-center text-center mb-6">
								...
								<h3 className="text-lg font-bold text-blue-900">AI Chatbot Development</h3>
							</div>
						...
						<div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 shadow-lg border border-green-100">
							<div className="flex flex-col items-center text-center mb-6">
								...
								<h3 className="text-lg font-bold text-green-900">NLP</h3>
							</div>
						...
						<div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-2xl p-8 shadow-lg border border-purple-100">
							<div className="flex flex-col items-center text-center mb-6">
								...
								<h3 className="text-lg font-bold text-purple-900">Predictive Analytics</h3>
							</div>
						...
						<div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl p-8 shadow-lg border border-cyan-100">
							<div className="flex flex-col items-center text-center mb-6">
								...
								<h3 className="text-lg font-bold text-cyan-900">Machine Learning</h3>
							</div>
						...
						<div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-2xl p-8 shadow-lg border border-yellow-100">
							<div className="flex flex-col items-center text-center mb-6">
								...
								<h3 className="text-lg font-bold text-yellow-900">Computer Vision</h3>
							</div>
						...
						<div className="bg-gradient-to-br from-red-50 to-pink-50 rounded-2xl p-8 shadow-lg border border-red-100">
							<div className="flex flex-col items-center text-center mb-6">
								...
								<h3 className="text-lg font-bold text-red-900">Chat GPT Integration</h3>
							</div>
			...
			<section className="py-20 px-6 lg:px-8 bg-gradient-to-br from-blue-900 via-green-900 to-cyan-900 relative">
				...
				<div className="relative z-10 max-w-4xl mx-auto">
					<div className="text-center space-y-6 mb-16">
						...
						<h2 className="text-xl lg:text-2xl font-bold text-white">Leading AI Development Platforms</h2>
					</div>
				...
				<div className="max-w-7xl mx-auto">
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
						...
						<div className="bg-white rounded-xl p-6 shadow-md flex flex-col items-center text-center">
							...
							<p className="text-gray-700 text-sm">We collect, cleanse, and transform raw data into a format ready for AI model training and analysis.</p>
						</div>
						{/* Model Selection */}
						<div className="bg-white rounded-xl p-6 shadow-md flex flex-col items-center text-center">
							...
							<p className="text-gray-700 text-sm">We identify the optimal AI model architecture based on your data and business objectives.</p>
						</div>
						{/* Model Training */}
						<div className="bg-white rounded-xl p-6 shadow-md flex flex-col items-center text-center">
							...
							<p className="text-gray-700 text-sm">We train and validate your AI model using best-in-class techniques to ensure accuracy and reliability.</p>
						</div>
						{/* Model Deployment */}
						<div className="bg-white rounded-xl p-6 shadow-md flex flex-col items-center text-center">
							...
							<p className="text-gray-700 text-sm">We seamlessly integrate your AI model into your business systems for real-world impact.</p>
						</div>
					</div>
				</div>
			</section>
			...
			<section className="py-20 px-6 lg:px-8 bg-gradient-to-br from-blue-900 via-green-900 to-cyan-900 relative">
				...
				<div className="relative z-10 max-w-7xl mx-auto">
					<div className="text-center mb-12">
						<h2 className="text-xl lg:text-2xl font-bold text-white mb-4">Why Partner with Us for AI Development?</h2>
						<p className="text-base text-white/80 max-w-2xl mx-auto">See why leading organizations trust us for AI development.</p>
					</div>
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
						{/* Expertise */}
						<div className="bg-white rounded-xl p-6 shadow-md flex flex-col items-center text-center">
							...
							<p className="text-gray-700 text-sm">Our team combines deep industry knowledge with advanced AI experience to deliver results you can trust.</p>
						</div>
						{/* Custom Solutions */}
						<div className="bg-white rounded-xl p-6 shadow-md flex flex-col items-center text-center">
							<div className="mb-4 w-12 h-12 flex items-center justify-center bg-green-100 rounded-full">
							...
							<p className="text-gray-700 text-sm">Every AI solution is custom-built to align with your business objectives and deliver maximum value.</p>
						</div>
						{/* Advanced Technology */}
						<div className="bg-white rounded-xl p-6 shadow-md flex flex-col items-center text-center">
							<div className="mb-4 w-12 h-12 flex items-center justify-center bg-yellow-100 rounded-full">
							...
							<p className="text-gray-700 text-sm">We utilize the latest AI tools and algorithms to ensure your solutions are accurate, scalable, and future-ready.</p>
						</div>
						{/* Proven Results */}
						<div className="bg-white rounded-xl p-6 shadow-md flex flex-col items-center text-center">
							<div className="mb-4 w-12 h-12 flex items-center justify-center bg-cyan-100 rounded-full">
							...
							<p className="text-gray-700 text-sm">Our AI solutions consistently drive efficiency, smarter decisions, and business growth for our clients.</p>
						</div>
						{/* End-to-End Support */}
						<div className="bg-white rounded-xl p-6 shadow-md flex flex-col items-center text-center">
