				...
				<div className="max-w-7xl mx-auto">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
						...
						<div className="bg-gradient-to-br from-cyan-50 to-blue-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-cyan-200 flex flex-col gap-3 sm:gap-4 items-center min-h-[200px] sm:min-h-[220px]">
							<div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 mx-auto">
								<svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>
							</div>
							<h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-2 text-center w-full">AI Chatbot Development</h3>
							<p className="text-xs sm:text-sm text-gray-800 text-center leading-relaxed">Intelligent conversational AI that enhances customer engagement and delivers personalized experiences.</p>
						</div>
						...
						<div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-green-200 flex flex-col gap-3 sm:gap-4 items-center min-h-[200px] sm:min-h-[220px]">
							<div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 mx-auto">
								<svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" /></svg>
							</div>
							<h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-2 text-center w-full">Natural Language Processing</h3>
							<p className="text-xs sm:text-sm text-gray-800 text-center leading-relaxed">Advanced NLP solutions that enable machines to understand and interpret human language.</p>
						</div>
						...
						<div className="bg-gradient-to-br from-purple-50 to-violet-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-purple-200 flex flex-col gap-3 sm:gap-4 items-center min-h-[200px] sm:min-h-[220px]">
							<div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-purple-500 to-violet-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 mx-auto">
								<svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
							</div>
							<h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-2 text-center w-full">Predictive Analytics</h3>
							<p className="text-xs sm:text-sm text-gray-800 text-center leading-relaxed">Data-driven forecasting solutions that predict trends and provide actionable insights.</p>
						</div>
						{/* Machine Learning */}
						<div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-blue-200 flex flex-col gap-3 sm:gap-4 items-center min-h-[200px] sm:min-h-[220px]">
							<div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 mx-auto">
								<svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg>
							</div>
							<h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-2 text-center w-full">Machine Learning</h3>
							<p className="text-xs sm:text-sm text-gray-800 text-center leading-relaxed">Custom ML models that analyze data to recognize patterns and provide competitive advantages.</p>
						</div>
						{/* Computer Vision */}
						<div className="bg-gradient-to-br from-yellow-50 to-amber-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-yellow-200 flex flex-col gap-3 sm:gap-4 items-center min-h-[200px] sm:min-h-[220px]">
							<div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-yellow-500 to-amber-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 mx-auto">
								<svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
							</div>
							<h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-2 text-center w-full">Computer Vision</h3>
							<p className="text-xs sm:text-sm text-gray-800 text-center leading-relaxed">Advanced image and video analysis for automation and quality control.</p>
						</div>
						{/* ChatGPT Integration */}
						<div className="bg-gradient-to-br from-pink-50 to-rose-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-pink-200 flex flex-col gap-3 sm:gap-4 items-center min-h-[200px] sm:min-h-[220px]">
							<div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-pink-500 to-rose-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 mx-auto">
								<svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
							</div>
							<h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-2 text-center w-full">ChatGPT Integration</h3>
							<p className="text-xs sm:text-sm text-gray-800 text-center leading-relaxed">Seamless integration of OpenAI's ChatGPT for natural conversational experiences.</p>
						</div>
					</div>
				</div>
			</section>
			...
			<section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-tr from-purple-50 to-white">
				<div className="max-w-7xl mx-auto">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
						{/* Automation */}
						<div className="bg-gradient-to-br from-cyan-50 to-blue-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-cyan-200 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px]">
							<div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 mx-auto">
								<svg className="w-7 h-7 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M13 10V3L4 14h7v7l9-11h-7z" strokeLinecap="round" strokeLinejoin="round"/></svg>
							</div>
						...
						{/* Scalability */}
						<div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-green-200 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px]">
							<div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 mx-auto">
						...
						{/* Customization */}
						<div className="bg-gradient-to-br from-purple-50 to-violet-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-purple-200 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px]">
							<div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-purple-500 to-violet-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 mx-auto">
						...
						{/* Innovation */}
						<div className="bg-gradient-to-br from-yellow-50 to-amber-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-yellow-200 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px]">
							<div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-yellow-500 to-amber-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 mx-auto">
								<svg className="w-7 h-7 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
							</div>
				...
				<div className="max-w-5xl mx-auto">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
						...
						<div className="bg-gradient-to-br from-cyan-50 to-blue-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-cyan-200 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px]">
							...
							<p className="text-xs sm:text-sm text-gray-800 text-center leading-relaxed">Pinpoint your business challenge to maximize AI development impact.</p>
						</div>
						...
						<div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-green-200 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px]">
							...
							<p className="text-xs sm:text-sm text-gray-800 text-center leading-relaxed">Curate high-quality data for optimal AI model performance.</p>
						</div>
						{/* Development & integration */}
						<div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-blue-200 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px]">
							...
							<p className="text-xs sm:text-sm text-gray-800 text-center leading-relaxed">Embed AI capabilities into your applications and systems.</p>
						</div>
				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
						...
						<div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-green-200 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px]">
							...
							<p className="text-xs sm:text-sm text-gray-800 text-center leading-relaxed">Bespoke AI development integrations for your unique business goals.</p>
						</div>
						{/* End-to-End Support */}
						<div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-blue-200 flex flex-col items-center gap-3 sm:gap-4 min-h-[180px] sm:min-h-[200px]">
							<span className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white mb-2">
			...
			<section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-tr from-purple-50 to-white">
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-8 sm:mb-12">
						...
						<p className="text-sm sm:text-base text-gray-800 max-w-2xl mx-auto px-4">We guide you through the journey of AI development with our proven steps.</p>
					</div>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
						{onboardingSteps.map((step, index) => {
							...
							return (
								<div key={index} className={`bg-gradient-to-br ${bgGradients[index]} rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-md flex items-start gap-3 sm:gap-4 border ${borders[index]} min-h-[120px] sm:min-h-[140px]`}>
									<div className={`w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center bg-white rounded-full shadow-lg border-2 ${borders[index]} flex-shrink-0`}>
										<div className={iconColors[index]}>
											{step.icon}
										</div>
									</div>
									<div className="flex-1">
										<h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-2">{step.title}</h3>
										<p className="text-xs sm:text-sm text-gray-800 leading-relaxed">{step.description}</p>
									</div>
								</div>
							);
						})}
					...
					<div className="space-y-3 sm:space-y-4">
						{faqData.map((faq, idx) => (
							...
							>
								...
								>
									<span className="font-semibold text-sm sm:text-base text-gray-900 text-left group-hover:text-blue-700 transition-colors duration-200 leading-relaxed pr-4">
										{faq.question}
									</span>
